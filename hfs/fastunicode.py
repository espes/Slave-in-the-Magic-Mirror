...
# converted to Python from XNU source code

gLowerCaseTable = [0x0100, 0x0200, 0x0000, 0x0300, 0x0400, 0x0500, 0x0000, 0x0000,
...
def FastUnicodeCompare(s1, s2):
    i, j = 0, 0
    while True:
        c1 = 0
        c2 = 0
        while (i < len(s1) and c1 == 0):
            c1 = ord(s1[i])
            i += 1
            temp = gLowerCaseTable[c1>>8]
            if temp != 0:
                c1 = gLowerCaseTable[temp + (c1 & 0x00FF)]

        while (j < len(s2) and c2 == 0):
            c2 = ord(s2[j])
            j += 1
            temp = temp = gLowerCaseTable[c2>>8]
            if (temp != 0):
                c2 = gLowerCaseTable[temp + (c2 & 0x00FF)]
